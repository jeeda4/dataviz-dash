...
dashboardPage(
    ...
    dashboardSidebar(sidebarMenu(id = "sidebar",
                                 ...
                                 conditionalPanel(condition="input.sidebar == 'plot'", radioButtons("plotOptions", "Select an option:", c("State of Florida cases"= "florida", "Cases by counties"= "county"))),
    ...
    dashboardBody(tabItems(
        ...
        tabItem(tabName = "plot",
                fluidPage(box(width=10, status="warning", title= "Florida COVID'19 Cases", solidHeader = TRUE, plotOutput("mytimeplot"))))
    ))
)
